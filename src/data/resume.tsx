...
export const DATA = {
  ...
  navbar: [
    ...
    { href: "https://medium.com/@satyapriyoak47", icon: NotebookIcon, label: "Blog" },
  ],
  contact: {
    email: "satyapriyobiswas1@gmail.com",
    tel: "+917439061601",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/Satyapriyo",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/satyapriyo-biswas-b88073225/",
        icon: Icons.linkedin,
      ...
      X: {
        name: "X",
        url: "https://x.com/Satyapriyo_dev",
        icon: Icons.x,
  ...
  education: [
    ...
    },
    {
      ...
      href: "https://school.banglarshiksha.gov.in/ws/website/index/19170112916",
      degree: "High School ",
  ...
  projects: [
    {
      ...
      image: "",
      video:
        "https://res.cloudinary.com/duyocx2j0/video/upload/v1748112157/Recording_2025-05-24_195756_xowaaf.mp4",
    },
    {
      title: "Magic UI",
